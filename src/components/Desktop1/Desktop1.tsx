...
export const Desktop1: FC<Props> = memo(function Desktop1(props = {}) {
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      ...
      <div className={classes.theTeam}>The Team</div>
      <div className={classes.getInTouch}>Get in Touch</div>
      <div className={classes.toddStumpf}>Todd Stumpf</div>
      <div className={classes.justinFehler}>Justin Fehler</div>
      ...
      <div className={classes.koremIpsumDolorSitAmetConsecte}>
        <div className={classes.textBlock}>
          ...
          torquent per conubia nostra, per inceptos himenaeos. Praesent auctor purus luctus enim egestas, ac scelerisque
          ante pulvinar. Donec ut rhoncus ex. Suspendisse ac rhoncus nisl, eu tempor urna. Curabitur vel bibendum lorem.
      ...
      <div className={classes.koremIpsumDolorSitAmetConsecte2}>
